...
public class Generator extends PayloadGenerator {
  
  public NewApplication newApplication(boolean german, String applicationNumber) {
    Person p = new Person();
    ...
    NewApplication a = new NewApplication(applicationNumber);
    a.setApplicant(p);
